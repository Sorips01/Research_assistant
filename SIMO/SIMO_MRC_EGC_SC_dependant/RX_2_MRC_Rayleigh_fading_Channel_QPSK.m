...
QPSK_BER_MRC_RX_2 = [QPSK_BER_MRC_RX_2; Demodulation(message, symbol, RX_count, 1)];
...
if (exist('RX_2_MRC_QPSK_Rayleigh_SIMO.mat', 'file') > 0)
    save('RX_2_MRC_QPSK_Rayleigh_SIMO.mat', 'QPSK_BER_MRC_RX_2', '-append');
else
    save('RX_2_MRC_QPSK_Rayleigh_SIMO.mat', 'QPSK_BER_MRC_RX_2');
end
